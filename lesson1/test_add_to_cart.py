...
def test_add_item_in_the_cart():
    ...
    text_before = driver.find_element(By.CSS_SELECTOR, "div[class='inventory_item_name']").text
    ...
    text_after = driver.find_element(By.CSS_SELECTOR, "div[class='inventory_item_name']").text
